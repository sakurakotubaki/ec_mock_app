...
class $CartItemsTable extends CartItems
  ...
  List<GeneratedColumn> get $columns =>
      [id, productId, name, price, imageUrl, quantity, addedAt];
  @override
...
class CartItem extends DataClass implements Insertable<CartItem> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, productId, name, price, imageUrl, quantity, addedAt);
  @override
...
class $FavoriteItemsTable extends FavoriteItems
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, productId, name, price, imageUrl, description, addedAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class FavoriteItem extends DataClass implements Insertable<FavoriteItem> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, productId, name, price, imageUrl, description, addedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
typedef $$CartItemsTableProcessedTableManager = ProcessedTableManager<
    ...
    CartItem,
    PrefetchHooks Function()>;
typedef $$FavoriteItemsTableCreateCompanionBuilder = FavoriteItemsCompanion
    Function({
  Value<int> id,
  required String productId,
  required String name,
...
typedef $$FavoriteItemsTableUpdateCompanionBuilder = FavoriteItemsCompanion
    Function({
  Value<int> id,
  Value<String> productId,
  Value<String> name,
...
class $$FavoriteItemsTableTableManager extends RootTableManager<
    _$AppDatabase,
    $FavoriteItemsTable,
    FavoriteItem,
    $$FavoriteItemsTableFilterComposer,
...
typedef $$FavoriteItemsTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $FavoriteItemsTable,
    FavoriteItem,
    $$FavoriteItemsTableFilterComposer,
